...
@section('content')
    <div class="my-8">
        <div class="m-4 text-red-900">
            <a href="{{ url('comunicacoes/cobricao/muar/') }}">
        ...
        <div class="mx-10 grid  grid-cols-2 grid-rows-3  gap-8 text-center text-white text-xs">
            <a href="{{ url("comunicacoes/cobricao/muar/transferencia/natural") }}" class="rounded-2xl border-red-400 bg-red-900 p-4 w-full">
                <img class="mx-auto my-2 w-16 h-16" src="{{ asset('img/monta-natural.png') }}">
                Monta Natural
            </a>
            <a href="{{ url("comunicacoes/cobricao/muar/transferencia/artificial") }}" class="rounded-2xl border-red-400 bg-red-900 p-4 w-full">
