...
@section('title', 'Cobrição - Transferencia Insiminação artificial de Muar')

@section('content')
    <div class="my-8">
        <div class="m-4 text-red-900">
            <a href="{{ url('comunicacoes/cobricao/muar/transferencia/') }}">
        ...
        <div class="text-center mb-5">
            <h2 class="text-2xl font-medium">Cobrição de Muar</h2>
        </div>
        ...
        <form id="multistep-form">
            <div class="step step-1 w-72 mx-auto">
                <div class="text-center mb-4">
                    <h1 class="text-lg">Selecionar o Material</h1>
                </div>
                ...
                <div class="flex items-center justify-center space-x-3">
                    <button type="button"
                        class="w-full next border border-red-900 rounded-lg p-2 bg-red-900 text-white hover:bg-red-800  focus:outline-none focus:border-red-900 focus:ring focus:ring-red-200">
                        Próximo
                    </button>
                </div>
            </div>
            ...
            <div class="step step-2 w-72 mx-auto">
                <div class="text-center mb-4">
                    <h1 class="text-lg">Selecionar médico veterinario</h1>
                </div>
                <div>
                    <h1 class="text-sm font-medium text-center mb-4">Buscar por:</h1>
                </div>
                <div class="flex justify-center ">
                ...
                <div class="flex items-center justify-center space-x-3">
                    <button type="button"
                        class="w-full prev border border-red-900 rounded-lg p-2 bg-red-900 text-white hover:bg-red-800  focus:outline-none focus:border-red-900 focus:ring focus:ring-red-200">
                        Anterior
                    </button>
                    <button type="button"
                        class="w-full next border border-red-900 rounded-lg p-2 bg-red-900 text-white hover:bg-red-800  focus:outline-none focus:border-red-900 focus:ring focus:ring-red-200">
