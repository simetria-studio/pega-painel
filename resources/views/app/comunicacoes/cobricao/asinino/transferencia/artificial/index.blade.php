@extends('layouts.app')
@section('title', 'Transferência de embriões - Inseminação artificial')
@section('content')
    <div class="my-8">
        <div class="m-4 text-red-900">
            <a href="{{ url('comunicacoes/cobricao/asinino/transferencia') }}">
        ...
        <form id="multistep-form">
            <div class="step step-1 w-72 mx-auto">
                <div class="text-center mb-5">
                    <h1 class="text-2xl font-medium">Inseminação Artificial</h1>
                </div>
                <div class="text-center mb-4">
                    <h1 class="text-xl font-medium">Selecionar o Material</h1>
                </div>
                ...
                <div class="flex items-center justify-center space-x-3">
                    <button type="button"
                        class="next w-full border border-red-900 rounded-md p-2 bg-red-900 text-white hover:bg-red-800  focus:outline-none focus:border-red-900 focus:ring focus:ring-red-200">
                        Próximo
                    </button>
                </div>
            </div>
            ...
            <div class="step step-2 w-72 mx-auto">
                <div class="text-center mb-5">
                    <h1 class="text-2xl font-medium">Selecionar médico veterinario</h1>
                </div>
                <div class="text-center mb-4">
                    <h3 class="text-lg font-medium">Buscar por:</h3>
                </div>
                <div class="flex justify-center">
            ...
            <div class="step step-3 w-72 mx-auto">
                ...
                <div class="flex justify-center mb-5">
                    <label class="w-full">Data da Transferência
                        <br>
                        <input type="date"
                            class="w-full py-2 pl-4 pr-4 text-gray-700 bg-gray-200 rounded-lg focus:outline-none focus:bg-white focus:shadow">
                    </label>
                ...
                <div class="flex justify-center mb-5 ">
                    <label class="w-full">Data da Inseminação
                        <br>
                        <input type="date"
                            class="w-full py-2 pl-4 pr-4 text-gray-700 bg-gray-200 rounded-lg focus:outline-none focus:bg-white focus:shadow">
                    </label>
                ...
                <div class="flex items-center justify-center space-x-3">
                    ...
                    <button type="button"
                        class="prev w-full border border-red-900 rounded-lg p-2 bg-red-900 text-white hover:bg-red-800  focus:outline-none focus:border-red-900 focus:ring focus:ring-red-200">Anterior</button>

                    <button type="submit"
                        class="w-full border border-red-900 rounded-lg p-2 bg-red-900 text-white hover:bg-red-800  focus:outline-none focus:border-red-900 focus:ring focus:ring-red-200">Enviar</button>
