...
@section('title', 'Cobrição - Asinino')
...
@section('content')
    <div class="my-8">
        ...
        <div class="text-center mb-5">
            <h1 class="text-2xl font-semibold">Cobrição Asinino</h1>
        </div>
        <div class="mx-10 grid  grid-cols-2 grid-rows-3  gap-8 text-center text-white text-xs">

            <a href="{{ route('app.gestacaoAsinino') }}" class="rounded-2xl border-red-400 bg-red-900 p-4 w-full">
